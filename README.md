...
По архитектуре придерживался примерно формата **FSD**, хотя без лишних папок, если в одном виджете Products, два хука и один компонент, не считаю нужным сразу плодить папки UI/Model с одним файлом.
